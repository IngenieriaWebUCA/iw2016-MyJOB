...
import es.uca.iw.myjob.domain.DireccionDataOnDemand;
import es.uca.iw.myjob.domain.Empresa;
import es.uca.iw.myjob.domain.EmpresaDataOnDemand;
...
privileged aspect EmpresaDataOnDemand_Roo_DataOnDemand {
    ...
    public void EmpresaDataOnDemand.setActividad_profesional(Empresa obj, int index) {
        ...
        if (actividad_profesional.length() > 255) {
            actividad_profesional = actividad_profesional.substring(0, 255);
        }
    ...
    public void EmpresaDataOnDemand.setN_empleados(Empresa obj, int index) {
        Float n_empleados = new Integer(index).floatValue();
